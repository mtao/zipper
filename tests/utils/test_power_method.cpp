...
TEST_CASE("power_method static 2x2", "[krylov][power_method]") {
    ...
    auto result = utils::krylov::power_method(M);
...
TEST_CASE("power_method static 3x3", "[krylov][power_method]") {
...
TEST_CASE("power_method symmetric 3x3", "[krylov][power_method]") {
...
TEST_CASE("power_method dynamic matrix", "[krylov][power_method]") {
...
TEST_CASE("power_method negative dominant eigenvalue", "[krylov][power_method]") {
...
TEST_CASE("power_method identity", "[krylov][power_method]") {
...
TEST_CASE("power_method non-square returns error", "[krylov][power_method]") {
...
TEST_CASE("power_method empty returns error", "[krylov][power_method]") {
...
TEST_CASE("power_method with initial guess", "[krylov][power_method]") {
    ...
    auto result = utils::krylov::power_method(M, guess);
