...
TEST_CASE("test_cross_product", "[vector][products]") {
    ...
    zipper::VectorBase c = zipper::views::binary::CrossProductView(a.view(),b.view());
    CHECK(c(0) == 0);
    CHECK(c(1) == 0);
    CHECK(c(2) ==1);

    zipper::VectorBase d = zipper::views::binary::CrossProductView(b.view(),a.view());
    CHECK(d(0) == 0);
    CHECK(d(1) == 0);
    CHECK(d(2) ==-1);

    zipper::VectorBase e = zipper::views::binary::CrossProductView(a.view(),c.view());
    CHECK(e(0) == 0);
    CHECK(e(1) == -1);
    CHECK(e(2) == 0);
