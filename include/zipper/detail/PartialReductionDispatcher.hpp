...
#include "zipper/expression/unary/detail/PartialReductionViewDispatcher.hpp"

namespace zipper::detail {

template <template <concepts::QualifiedExpression> typename DerivedT,
          zipper::concepts::QualifiedExpression ViewType, rank_type... Indices>
...
private:
  expression::unary::detail::PartialReductionDispatcher<ViewType, Indices...>
      m_view_dispatcher;
};
