...
template <typename, typename> struct assignable_extents;
...
struct assignable_extents<zipper::extents<FromIndices...>,
  ...
  value_runtime(const zipper::extents<FromIndices...> &o) {
...
template <concepts::Extents From, concepts::Extents To>
