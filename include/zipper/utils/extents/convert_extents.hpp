...
template <typename, typename> struct ConvertExtents {};
template <index_type... FromIndices, index_type... ToIndices>
struct ConvertExtents<zipper::extents<FromIndices...>,
                      zipper::extents<ToIndices...>> {
  static zipper::extents<ToIndices...>
  run(const zipper::extents<FromIndices...> &s)
...
template <concepts::Extents A, index_type... ToIndices>
