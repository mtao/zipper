...
namespace _detail_arith {
    template <zipper::concepts::QualifiedExpression ExprA,
        ...
        requires(std::is_same_v<typename expression::detail::ExpressionTraits<
                                    std::decay_t<ExprA>>::value_type,
                                typename expression::detail::ExpressionTraits<
                                    std::decay_t<ExprB>>::value_type>)
    struct scalar_type {
        using ATraits =
            expression::detail::ExpressionTraits<std::decay_t<ExprA>>;
        using BTraits =
            expression::detail::ExpressionTraits<std::decay_t<ExprB>>;
...
template <zipper::concepts::QualifiedExpression ExprA,
          zipper::concepts::QualifiedExpression ExprB>
using Plus = Operation<ExprA,
                       ExprB,
                       std::plus<_detail_arith::scalar_type_t<ExprA, ExprB>>>;

template <zipper::concepts::QualifiedExpression ExprA,
          zipper::concepts::QualifiedExpression ExprB>
using Minus = Operation<ExprA,
                        ExprB,
...
template <zipper::concepts::QualifiedExpression ExprA,
          zipper::concepts::QualifiedExpression ExprB>
using Less = Operation<ExprA,
                       ExprB,
                       std::less<_detail_arith::scalar_type_t<ExprA, ExprB>>>;
...
template <zipper::concepts::QualifiedExpression ExprA,
          zipper::concepts::QualifiedExpression ExprB>
using Min = Operation<ExprA,
                      ExprB,
                      detail::min<_detail_arith::scalar_type_t<ExprA, ExprB>>>;

template <zipper::concepts::QualifiedExpression ExprA,
          zipper::concepts::QualifiedExpression ExprB>
using Max = Operation<ExprA,
                      ExprB,
                      detail::max<_detail_arith::scalar_type_t<ExprA, ExprB>>>;

template <zipper::concepts::QualifiedExpression ExprA,
          zipper::concepts::QualifiedExpression ExprB>
using ThreeWayCompare = Operation<ExprA, ExprB, std::compare_three_way>;
