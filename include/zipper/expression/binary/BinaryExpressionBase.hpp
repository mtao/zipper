...
namespace detail {
    ...
    /// Default traits for binary expressions. Inherits from
    ...
    template <zipper::concepts::QualifiedExpression ChildA,
              zipper::concepts::QualifiedExpression ChildB>
        requires(
            std::is_convertible_v<typename expression::detail::ExpressionTraits<
                                      std::decay_t<ChildA>>::value_type,
                                  typename expression::detail::ExpressionTraits<
                                      std::decay_t<ChildB>>::value_type>
    ...
    struct DefaultBinaryExpressionTraits
      : public expression::detail::BasicExpressionTraits<
        ...
        /// expressions are moved in by value but still hold references to
        /// a,b,c,d.
        ...
        constexpr static bool is_view_propagating =
            _Detail::ATraits::is_view_propagating
            && _Detail::BTraits::is_view_propagating;
...
class BinaryExpressionBase : public expression::ExpressionBase<Derived> {
  public:
