...
using LogicalNot =
    CoefficientWiseOperation<Expression,
              std::logical_not<typename zipper::expression::detail::
                                   ExpressionTraits<std::decay_t<Expression>>::value_type>>;
...
template <typename Scalar, zipper::concepts::QualifiedExpression Expression,
          bool ScalarOnRight>
using ScalarPlus = ScalarOperation<
    Expression,
    std::plus<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
...
using ScalarMinus = ScalarOperation<
    Expression,
    std::minus<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarMultiplies =
    ScalarOperation<Expression,
                    std::multiplies<std::common_type_t<
                        Scalar, typename std::decay_t<Expression>::value_type>>,
                    Scalar, ScalarOnRight>;
...
using ScalarDivides = ScalarOperation<
    Expression,
    std::divides<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarModulus = ScalarOperation<
    Expression,
    std::modulus<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarEqualsTo = ScalarOperation<
    Expression,
    std::equal_to<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarGreater = ScalarOperation<
    Expression,
    std::greater<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarLess = ScalarOperation<
    Expression,
    std::less<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarBitAnd = ScalarOperation<
    Expression,
    std::bit_and<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarBitOr = ScalarOperation<
    Expression,
    std::bit_or<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
...
using ScalarBitXor = ScalarOperation<
    Expression,
    std::bit_xor<std::common_type_t<Scalar, typename std::decay_t<Expression>::value_type>>,
    Scalar, ScalarOnRight>;
