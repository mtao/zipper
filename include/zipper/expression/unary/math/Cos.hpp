#if !defined(ZIPPER_EXPRESSION_UNARY_MATH_COS_HPP)
#define ZIPPER_EXPRESSION_UNARY_MATH_COS_HPP
...
using Cos = CoefficientWiseOperation<
    Child,
    detail::cos<typename zipper::expression::detail::ExpressionTraits<
        Child>::value_type>>;
