#if !defined(ZIPPER_EXPRESSION_UNARY_MATH_ROUND_HPP)
#define ZIPPER_EXPRESSION_UNARY_MATH_ROUND_HPP
...
using Round = CoefficientWiseOperation<
    Child,
    detail::round<typename zipper::expression::detail::ExpressionTraits<
        Child>::value_type>>;
...
struct zipper::expression::detail::is_zero_preserving_unary_op<
    zipper::expression::unary::detail::round<T>> : std::true_type {};
