...
template<zipper::concepts::Matrix M>
    requires(M::extents_type::static_extent(0) == 3 && M::extents_type::static_extent(1) == 3)
...
auto slerp(const Q1 &q1, const Q2 &q2, typename Q1::value_type t) -> Quaternion<typename Q1::value_type> {
