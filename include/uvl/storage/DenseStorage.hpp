#if !defined(UVL_STORAGE_DENSE_HPP)
#define UVL_STORAGE_DENSE_HPP
          ...
          AccessorPolicy>  // requires(StorageExtentsTraits<Extents>::is_static)
{
    ...
    mdspan_type as_mdspan() { return mdspan_type{m_data.data()}; }
    const mdspan_type as_mdspan() const { return mdspan_type{m_data.data()}; }
   ...
   private:
    ...
    std::array<value_type, StorageExtentsTraits::static_size> m_data;
};
